...
const GIFS_FIXOS = {
  cumprimentar: "https://media.giphy.com/media/3o6nUN5U3cUyxAmMCs/giphy.gif",
  highfive: "https://media.giphy.com/media/0MHgWp8xxjdd0TW0n6/giphy.gif",
  acenar: "https://media.giphy.com/media/HWmfB90HSjjHzt0IYb/giphy.gif",
  dancar: "https://media.giphy.com/media/JthNWtSFmSnVjfMI1X/giphy.gif",
  rir: "https://media.giphy.com/media/K1VeYsqThPkpy9osKD/giphy.gif",
  sorrir: "https://media.giphy.com/media/Fu3OjBQiCs3s0ZuLY3/giphy.gif",
  tapa: "https://media.giphy.com/media/10KJUgvMoiSVSo/giphy.gif",
  soco: "https://media.giphy.com/media/03D7Mkj0qKopdiEMKe/giphy.gif",
  bonk: "https://media.giphy.com/media/pPs4HwdYb46fWfnpje/giphy.gif"
};
...
${ctx.prefix}${ctx.cmd} @pessoa`
  ...
  try{
    ...
    await ctx.sock.sendMessage(ctx.jid,{text:`${legenda}\n\n⚠️ O GIF correspondente não carregou desta vez.`,mentions});
  }
  return true;
};
